...
const Message: React.FC<Props> = ({
  ...
  return (
    <div
      className="relative my-2 mx-auto w-11/12 rounded-2xl bg-gray-200 py-8 text-center text-lg font-normal text-gray-900 shadow-xl dark:bg-gray-800 dark:text-white lg:w-4/5"
      onClick={(e) => {
        e.stopPropagation();
