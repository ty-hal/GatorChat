const SkeletonThreadPreview = () => {
  return (
    <div
      className="relative my-2 mx-auto w-11/12 animate-pulse rounded-2xl border-2 border-gray-500 bg-gray-200 pt-8 pb-16 shadow-md dark:bg-gray-800 lg:w-4/5"
      id="container"
    >
...
export default SkeletonThreadPreview;
